...
export class SecureInput extends HTMLElement {
    ...
    private setupShadowDOM(): void {
        ...
        this.button = this.shadowRootRef.querySelector('.secure-input-button') as HTMLButtonElement;
    }
    ...
    private handleSecureSubmit(): void {
        ...
        this.showSecureAlert(
            `Shadow DOM Value: "${value}"\n\n` +
